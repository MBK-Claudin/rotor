        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#" id="newClient">Nouveau client</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#" id="oldClient">Ancien client</a></li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="col-12 grid-margin">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-sample" id="new">
                            ...
                            <p class="card-description"> Client </p>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">nom</label>
                                        <div class="col-sm-9">
                                            <select name="old_cli" id="old_cli" class="form-control">
                                                <?php
                                                while ($rows = $client->fetch_assoc()) {
                                                    echo "<option value=" . $rows["id_cli"] . ">" . $rows["nom_cli"] . "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function(){
            ...
            document.getElementById("new").addEventListener("submit", function(){
                ...
                if (!formData.get("id_voiture") || !formData.get("quantite") || !formData.get("montant") ||
                    !formData.get("date") || !formData.get("nom_cli") || !formData.get("prenom_cli") ||
                    !formData.get("adresse_cli") || !formData.get("tel") ) {
                    alert("Tous les champs sont obligatoires !");
                }else{

                    fetch('../traitement/caisse/nouvelle_vente.php', {
                        method: 'POST',
                        body: formData
            ...
            document.getElementById("old").addEventListener("submit", function(){
                ...
                if (!formData.get("id_voiture_old") || !formData.get("quantite_old") || !formData.get("montant_old") ||
                    !formData.get("date_old") || !formData.get("old_cli") ) {
                    
                    alert("Tous les champs sont obligatoires !");

                }else{

                    fetch('../traitement/caisse/ancienne_vente.php', {
                        method: 'POST',
                        body: formData
                    }).then(response => response.json())
                    .then(data => {
